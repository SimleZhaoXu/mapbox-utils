import{b as e,_ as i,a as n}from"./index.ff7ff852.js";import{d as p}from"./heatmapData.cf83918a.js";import{_ as s,d as m,r as t,c as l,h as c,k as d,o as u}from"./index.3f3ae0c4.js";const f=`
<template>
  <div class="page">
...
`;var y={base:f};const v={class:"circle-point-demo"},_=m({__name:"index",setup(h){delete e["map-view.vue"];const a=d(),o=t({"index.vue":{code:y[a.params.id]},"data.json":{code:p},...e}),r=t({...n});return(b,x)=>(u(),l("div",v,[c(i,{files:o.value,"main-file":"index.vue","import-map":r.value},null,8,["files","import-map"])]))}});var L=s(_,[["__scopeId","data-v-53ed41ce"]]);export{L as default};
