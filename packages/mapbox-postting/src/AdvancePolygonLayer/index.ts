...
import { bbox, bboxPolygon, getCoord, centroid, clone, featureCollection } from '@turf/turf'
type Data =
...
export default class AdvancePolygonLayer extends mapboxgl.Evented {
  ...
  constructor(options: Options) {
    ...
    this._source = `advance-polygon-layer${nanoid()}`
  ...
  private _getFeature(val: any) {
    ...
    let feature: GeoJSON.Feature<GeoJSON.Polygon | GeoJSON.MultiPolygon> | undefined
